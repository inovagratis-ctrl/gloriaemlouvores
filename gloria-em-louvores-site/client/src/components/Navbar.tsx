        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <Link href="/" className="flex items-center gap-2.5 group">
              <div className={`bg-[#1a1f3a] rounded-xl p-1.5 transition-all duration-300 ${scrolled ? "shadow-md" : "shadow-2xl"}`}>
                <img src="/images/logotipo.png" alt="Glória em Louvores" className="h-10 sm:h-12 md:h-14 object-contain" />
              </div>
            </Link>
        ...
        <div className={`absolute top-0 right-0 w-72 h-full bg-white shadow-2xl transition-transform duration-300 ${
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-8">
              <div className="bg-[#1a1f3a] rounded-xl p-1.5">
